...
public class MyPieChartRenderer extends DataRenderer {
    ...
    public MyPieChartRenderer(PieChart chart, ChartAnimator animator,
        ...
        mEntryLabelsPaint.setTextSize(Utils.convertDpToPixel(12f));
    ...
    protected void drawEntryLabel(Canvas c, String label, float x, float y) {
        ...
        String[] texts = label.split(System.getProperty("line.separator"));
        for(String text : texts){
            c.drawText(text, x, y, mEntryLabelsPaint);
            y = y + 40;
        }
