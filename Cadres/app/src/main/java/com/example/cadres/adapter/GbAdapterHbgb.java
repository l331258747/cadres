...
public class GbAdapterHbgb extends RecyclerView.Adapter<GbAdapterHbgb.ViewHolder> {

    Context mContext;
    List<DBGbBean> datas;

    public GbAdapterHbgb(Context mContext, List<DBGbBean> datas) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(mContext).inflate(R.layout.item_gb_hbgb, parent, false);
