...
public class GbCadreNowPositionListBean {
    /**
     * positionId : 228
     * deptId : 207
     * deptName : 乡镇1
     * baseId : 218
     * cadreName : 张三
     * positionTime : 2020-06-10
     * position : 在任
     * positionTitle : 201
     * positionTitleName : 副书记
     * positionReason : 挂职
     * positionFileNumber :
     * dutiesRank : 1
     * vacantPosition : 是
     * createBy : 管理员
     * createTime : 2020-06-19 17:04:22
     * updateBy : 管理员
     * updateTime : 2020-06-22 15:14:19
     */
    ...
    public GbCadreNowPositionListBean(int positionId, int deptId, String deptName, int baseId, String cadreName, String positionTime, String position, int positionTitle, String positionTitleName, String positionReason, String positionFileNumber, String dutiesRank, String vacantPosition) {
