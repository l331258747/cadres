...
public class GbFamilyAdapter2 extends RecyclerView.Adapter<GbFamilyAdapter2.ViewHolder> {

    Context mContext;
    List<DBGbCadreFamilyMemberList> datas;

    public GbFamilyAdapter2(Context mContext, List<DBGbCadreFamilyMemberList> datas) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(mContext).inflate(R.layout.item_gb_family2, parent, false);
